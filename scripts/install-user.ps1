...
try {
  ...
  Write-Host ""
  Write-Host "Daemon status command:"
  ...
  Write-Host ""
  Write-Host "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
  Write-Host "⚠️  One manual Chrome step remains"
  Write-Host "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
  Write-Host ""
  Write-Host "Chrome does not let scripts install this unpacked extension automatically."
  Write-Host "Do this once in the Chrome browser you want agents to control:"
  Write-Host ""
  Write-Host "1. Open Chrome and go to:"
  Write-Host "   chrome://extensions"
  Write-Host ""
  Write-Host "2. Turn on:"
  Write-Host "   Developer mode"
  Write-Host ""
  Write-Host "3. Click:"
  Write-Host "   Load unpacked"
  Write-Host ""
  Write-Host "4. When Chrome asks for a folder, select EXACTLY this folder:"
  Write-Host "   $extensionDir"
  Write-Host ""
  Write-Host "   Tip: select the folder named 'extension' itself."
  Write-Host "   Do NOT select manifest.json or any file inside the folder."
  Write-Host ""
  Write-Host "5. Verify connection:"
  Write-Host "   $installedCmd status"
  Write-Host ""
  Write-Host "Expected after loading the extension:"
  Write-Host "  Extension: Connected"
  Write-Host ""
  Write-Host "If you see 'Extension: Not connected', reload the extension in chrome://extensions"
  Write-Host "or make sure you loaded the folder shown above."
  Write-Host "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
  Write-Host ""
